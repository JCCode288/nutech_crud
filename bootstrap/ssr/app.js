...
createInertiaApp({
  ...
  resolve: (name) => resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./Pages/API/Index.vue": () => import("./assets/Index-NK0ls1Uw.js"), "./Pages/API/Partials/ApiTokenManager.vue": () => import("./assets/ApiTokenManager-mC_5GjTF.js"), "./Pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-22WR5Cfw.js"), "./Pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-v0234yNJ.js"), "./Pages/Auth/Login.vue": () => import("./assets/Login-QwgHPQtk.js"), "./Pages/Auth/Register.vue": () => import("./assets/Register-2Et2VH2Q.js"), "./Pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword-moqwGDCQ.js"), "./Pages/Auth/TwoFactorChallenge.vue": () => import("./assets/TwoFactorChallenge-hPWMlOf0.js"), "./Pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-_TdO4tzo.js"), "./Pages/Dashboard.vue": () => import("./assets/Dashboard-U57on3qt.js"), "./Pages/PrivacyPolicy.vue": () => import("./assets/PrivacyPolicy-_8K2Mfp4.js"), "./Pages/Profile/Partials/DeleteUserForm.vue": () => import("./assets/DeleteUserForm-9wls-DAn.js"), "./Pages/Profile/Partials/LogoutOtherBrowserSessionsForm.vue": () => import("./assets/LogoutOtherBrowserSessionsForm-acgCvfGk.js"), "./Pages/Profile/Partials/TwoFactorAuthenticationForm.vue": () => import("./assets/TwoFactorAuthenticationForm-CNcFwwYm.js"), "./Pages/Profile/Partials/UpdatePasswordForm.vue": () => import("./assets/UpdatePasswordForm-FZcUuPlF.js"), "./Pages/Profile/Partials/UpdateProfileInformationForm.vue": () => import("./assets/UpdateProfileInformationForm-ZtF-Wd6m.js"), "./Pages/Profile/Show.vue": () => import("./assets/Show-NZgvVSRu.js"), "./Pages/TermsOfService.vue": () => import("./assets/TermsOfService-pOyHwZHH.js"), "./Pages/Welcome.vue": () => import("./assets/Welcome-BF_uSPwW.js") })),
  setup({ el, App, props, plugin }) {
    return createApp({ render: () => h$1(App, props) }).use(plugin).use(P).mount(el);
  },
  progress: {
    color: "#4B5563"
  }
